...
//        }
        ...
        if (use_hog == 0) {
            ...
            gradHist2( M, O, H, h, w, bin_size, n_orients, soft_bin, full );
        } else if (use_hog == 1) {
            full = false;   //by default
            hog2( M, O, H, h, w, bin_size, n_orients, soft_bin, full, clip );
        } else {
            fhog2( M, O, H, h, w, bin_size, n_orients, soft_bin, clip );
        }
